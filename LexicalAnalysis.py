# -*- coding: utf-8 -*-
"""
Created on Fri Dec  6 09:22:37 2019

@author: Hammad Azhar Khan
"""
...
all_syms = ["End_of_input", "Op_multiply", "Op_divide", "Op_mod", "Op_add", "Op_subtract",
    ...
    "Keyword_else", "Keyword_while", "Keyword_print", "LeftParen",
...
key_words = {'if': tk_If, 'else': tk_Else, 'Console.WriteLine': tk_Print, 'while': tk_While }
